...
<div xmlns="http://www.w3.org/1999/xhtml" class="x-purpose window x-full-screen container-fluid main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:13px;top:202px;"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="id" name="fID" type="String" xid="column2"/>  
      <column label="父级ID" name="fOneID" type="String" xid="column3"/>  
      <column label="标题" name="fTitle" type="String" xid="column1"/>  
      <column label="图片" name="fImg" type="String" xid="xid8"/> 
    </div> 
  </div>  
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row1"
    style="height:100%;"> 
    <div class="col col-xs-3 panel" xid="col1" style="height:100%; overflow: auto;">
      <div component="$UI/system/components/justep/list/list" class="x-list"
        xid="list4" data="placeOneData"> 
        <ul xid="listTemplateUl4" class="x-list-template"> 
          <li xid="li3" class="text-center panel-body" bind-css="{'x-active':val('fID')==data.val('fID')}"> 
            <div class="panel-heading" xid="div2"> 
              <img src="" alt="" bind-attr-src="$model.getLeftImageUrl($object)"
                class="img6" xid="image1"/>  
    ...
    <div class="col col-xs-9" xid="col4" style="height:100%; overflow: auto;">
