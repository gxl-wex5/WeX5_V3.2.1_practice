...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog"
    title="选择城市" showTitle="true" onReceive="windowDialogReceive" style="left:120px;top:10px;"/>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card top-trans"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-left text-success" xid="div1"> 
          ...
          <span xid="cityName" bind-click="cityBtnClick" class="h5 text-success"><![CDATA[昆明]]></span> 
        </div>  
        <div class="x-titlebar-title"> 
          ...
          <div class="form-group has-feedback text-muted"> 
            <input component="$UI/system/components/justep/input/input" class="form-control x-inputText" xid="key" onChange="listClick"/>
    ...
    <div class="x-panel-content x-cards" xid="content"> 
      <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
        active="0" xid="contents1" onActiveChange="contents1ActiveChange"> 
        <div class="x-contents-content" xid="homeContent">
          <div component="$UI/system/components/bootstrap/carousel/carousel"
            ...
            <div class="x-contents carousel-inner" role="listbox" component="$UI/system/components/justep/contents/contents"
              ...
              <div class="x-contents-content" xid="content3"> 
                <img alt="" xid="image1" id="image1" class="image-wall img1" bind-attr-src="$model.getImageUrl('./img/4.jpg')"/>
              </div>  
              ...
              <div class="x-contents-content" xid="content6"> 
                <img alt="" xid="image14" id="image14" class="image-wall img1" bind-attr-src="$model.getImageUrl('./img/1.jpg')"/>
              </div>  
              <div class="x-contents-content" xid="content7"> 
                <img alt="" xid="image15" id="image15" class="image-wall img1" bind-attr-src="$model.getImageUrl('./img/5.jpg')"/>
              </div> 
            </div> 
          </div>  
          <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card x-tuniu"
            ...
            <table class="table x-noborder" component="$UI/system/components/bootstrap/table/table"
              xid="table1"> 
              <tbody class="x-list-template" xid="listTemplate1" bind-click="listClick"> 
                <tr xid="tr2" class="text-center"> 
                  <td xid="td1"> 
                    <img alt="" xid="image37"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_group.png')"/>  
                    <div xid="div32" bind-text="'跟团游'" class="h6">跟团游</div>
                  </td>  
                  <td xid="td2"> 
                    <img alt=""
                      xid="image33" class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_self_service.png')"/>  
                    <div xid="div33" bind-text="'自助游'" class="h6">自助游</div>
                  </td>  
                  <td xid="td3"> 
                    <img alt="" xid="image34"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_ship.png')"/>  
                    <div xid="div31" bind-text="'游轮'" class="h6">游轮</div>
                  </td>  
                  <td xid="td4"> 
                    <img alt="" xid="image35"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_drive.png')"/>  
                    <div xid="div37" bind-text="'自驾游'" class="h6">自驾游</div>
                  </td>  
                  <td xid="td5"> 
                    <img alt="" xid="image36"
                      class="img5 img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/home_ticket.png')"/>  
                ...
                <tr xid="tr3" class="text-center"> 
                  <td xid="td8"> 
                    <img alt="" xid="image42"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_visa.png')"/>  
                    <div xid="div44" bind-text="'签证'" class="h6">签证</div>
                  </td>  
                  <td xid="td9"> 
                    <img alt="" xid="image41"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_hotel.png')"/>  
                    <div xid="div40" bind-text="'酒店'" class="h6">酒店</div>
                  </td>  
                  <td xid="td10"> 
                    <img alt="" xid="image39"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_plane.png')"/>  
                    <div xid="div45" bind-text="'机票'" class="h6">机票</div>
                  </td>  
                  <td xid="td11"> 
                    <img alt="" xid="image43"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_train.png')"/>  
                    <div xid="div42" bind-text="'火车票'" class="h6">火车票</div>
                  </td>  
                  <td xid="td12"> 
                    <img alt="" xid="image40"
                      class="img5 center-block" bind-attr-src="$model.getImageUrl('./img/home_hotspot.png')"/>  
          ...
          <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-tuniu"
            ...
            <table class="table table-bordered x-fill" component="$UI/system/components/bootstrap/table/table"
              ...
              <tbody class="x-list-template" xid="listTemplate2" bind-click="listClick"> 
                <tr xid="tr5"> 
                  <td xid="td13"> 
                    <img alt="" xid="image44"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity1.jpg')"/>
                  </td>  
                  <td xid="td14"> 
                    <img alt="" xid="image45"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity2.jpg')"/>
                  </td>  
                  <td xid="td15"> 
                    <img alt="" xid="image46"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity3.jpg')"/>
                  </td> 
                </tr>  
                <tr xid="tr6"> 
                  <td xid="td17"> 
                    <img alt="" xid="image49"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity4.jpg')"/>
                  </td>  
                  <td xid="td18"> 
                    <img alt="" xid="image47"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity5.jpg')"/>
                  </td>  
                  <td xid="td19"> 
                    <img alt="" xid="image48"
                      class="img-responsive" bind-attr-src="$model.getImageUrl('./img/activity6.jpg')"/>
                  </td> 
                </tr> 
              </tbody> 
            </table> 
          ...
          <div class="panel panel-default x-card x-tuniu" component="$UI/system/components/bootstrap/panel/panel"
            ...
            <div class="panel-heading text-muted" xid="heading2"> 
              <h4 class="panel-title" xid="h42">手机特卖
                <span xid="span20" class="text-success pull-right" bind-click="listClick">更多&gt;</span>
              </h4> 
            </div>  
            <table class="table x-noborder iSale" component="$UI/system/components/bootstrap/table/table"
              xid="table4"> 
              <tbody class="x-list-template" xid="listTemplate3" bind-click="listClick"> 
                <tr xid="tr4"> 
                  <td xid="td6"> 
                    <img alt="" xid="image22"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a1.jpg')"/>  
                  ...
                  <td xid="td7"> 
                    <img alt="" xid="image23"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a2.jpg')"/>  
                  ...
                  <td xid="td16"> 
                    <img alt="" xid="image24"
                      class="img-rounded img-responsive center-block" bind-attr-src="$model.getImageUrl('./img/a3.jpg')"/>  
                ...
                <tr xid="tr7"> 
                  <td xid="td20"> 
                    <img alt="" xid="image25"
                      class="img-rounded center-block" bind-attr-src="$model.getImageUrl('./img/a4.jpg')"/>  
                  ...
                  <td xid="td21"> 
                    <img alt="" xid="image26"
                      class="img-rounded center-block" bind-attr-src="$model.getImageUrl('./img/a5.jpg')"/>  
                  ...
                  <td xid="td22"> 
                    <img alt="" xid="image27"
                      class="img-rounded center-block" bind-attr-src="$model.getImageUrl('./img/a6.jpg')"/>  
          ...
          <div class="panel panel-default x-card x-tuniu" component="$UI/system/components/bootstrap/panel/panel"
            ...
            <div class="panel-heading" xid="heading1"> 
              <h4 class="panel-title" xid="h41">产品经理推荐
                <span xid="span7" class="text-success pull-right" bind-click="listClick">更多&gt;</span>
              </h4> 
            </div>  
              ...
              <ul class="x-list-template" xid="listTemplateUl1" bind-click="detailClick"> 
                <li xid="li1" class="list-group-item x-flex"> 
                  <div xid="div8" class="media-left"> 
                    <a xid="a1"> 
                      <img alt="" xid="image4" class="img-rounded img-responsive"
                        style="width:64px" bind-attr-src="$model.getImageUrl(val('fImg'))"/>
                    </a> 
                  </div>  
                  <div class="x-flex1" xid="col26"> 
                    <span xid="span21" bind-text="ref('fTitle')" style="text-align: justify;"/>
                  </div>  
                  <div class="" xid="col25"> 
                    <div xid="div34" class="text-danger text-right"> 
                      <span xid="span22">￥</span>  
                      <span xid="span23" bind-text="ref('fPrice')"/>
                    </div>  
                    <div xid="div35" class="text-muted text-right"> 
                      <span xid="span24" bind-text="ref('fSatisfaction')"/>  
                      <span xid="span25">%满意</span>
                    </div> 
                  </div> 
                </li> 
              </ul> 
        ...
        <div class="x-contents-content" xid="purposeContent" onActive="purposeContentActive">
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="purposeContainer" style="height:100%;width:100%;"/>
        </div>  
        <div class="x-contents-content" xid="classContent" onActive="classContentActive">
          <div component="$UI/system/components/justep/windowContainer/windowContainer"
            class="x-window-container" xid="classContainer"/>
        </div>  
