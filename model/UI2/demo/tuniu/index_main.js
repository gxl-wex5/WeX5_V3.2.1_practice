define(function(require) {
	...
	Model.prototype.purposeContentActive = function(event){
		this.loadContainer("purposeContainer", "$UI/demo/tuniu/index-purpose.w");
	};
	
	Model.prototype.classContentActive = function(event){
		this.loadContainer("classContainer", "$UI/demo/tuniu/index-class.w");
	};
	
	Model.prototype.userContentActive = function(event){
		this.loadContainer("userContainer", "$UI/demo/tuniu/index-user.w");
	};
