...
define(function(require) {
	...
	Model.prototype.modelLoad = function(event) {
		...
		this.appEngine.getConfig().proxyBuilderServer = templateService.getAppBuilderServerUrl();
		...
		this.appEngine.buildFinishedNotify = function(result) {
			...
			if (result.flag && result.code != "ERROR") {
				...
				templateService.selectFile(self.nativePath + '/' + self.appEngine.getConfig().projectName + '/dist');
			}
		};
		this.openPage({
			id : "appInfo",
