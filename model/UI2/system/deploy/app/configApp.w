...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="window" sysParam="false">  
  ...
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label20" xid="labelInput3">
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="packageName" placeHolder="例：com.justep.x5， ios的包名需要与证书中的BundleID一致"></input></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label20" xid="labelInput4">
   <label class="x-label" xid="label4"><![CDATA[应用描述：]]></label>
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="description" placeHolder="例：这是一个用于演示WeX5特性的应用"></input></div><div xid="div2" style="padding-top:8px"><span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="extBrowser" label="增强型浏览器（基于Crosswalk，Android平台有效）。使用更快速和更强的浏览器引擎，但生成的本地App文件会更大（多16MB），建议Android4.4以下版本的设备使用" checked="false"></span></div>
  <div xid="div1" style="padding-top:8px">
   <span component="$UI/system/components/justep/button/checkbox" class="x-checkbox" xid="resEncryption" label="打包的资源进行加密。加密后应用运行将略多一点资源读取时间，但可以增强应用的安全性，使反编译无法直接获取资源"></span></div>
