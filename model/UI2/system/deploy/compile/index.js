	...
	Model.prototype.modelLoad = function(event) {
		...
		this.appEngine.buildFinishedNotify = function(result) {
			...
			if (result.flag && result.code != "ERROR") {
				templateService.refreshFile(self.nativePath + '/' + self.appEngine.getConfig().projectName);
				templateService.selectFile(self.nativePath + '/' + self.appEngine.getConfig().projectName + '/www');
			}
		};
		this.openPage({
			id : "appInfo",
