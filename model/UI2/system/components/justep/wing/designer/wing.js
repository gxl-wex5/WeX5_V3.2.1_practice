...
define(function (require) {
	...
	var cls = Panel.extend({
		...
		addLeft: function(){
			...
			xuiService.getXuiDoc().createComponent("$UI/system/components/justep/wing/wing#left", this, {before:id, paintComponent:true});
		},
		addRight: function(){
			var id = this.$content.attr('d_id');
			xuiService.getXuiDoc().createComponent("$UI/system/components/justep/wing/wing#right", this, {before:id, paintComponent:true});
		},
