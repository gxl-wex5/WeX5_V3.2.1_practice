...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:mobile">  
  ...
  <span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver" style="left:38px;top:14px;"></span><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"> 
              ...
              <li xid="li1" bind-click="open"> 
                <div component="$UI/system/components/justep/controlGroup/controlGroup"
                  ...
                  <div class="x-control-group-title" xid="controlGroupTitle1"> 
                    <span xid="span1" bind-text="ref('title')"/> 
                  </div>  
                  <div style="text-align:center"> 
                    <img class="x-img-hw" bind-attr-src="$model.getImageUrl($object)"/> 
                  </div> 
                </div> 
              </li> 
            </ul> 
