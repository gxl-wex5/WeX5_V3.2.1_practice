define(function(require) {
	...
	return {
		...
		getFuncIframe : function(tabId){
			...
			if($iframe.size()>0) return $iframe.get(0);
		},
		...
		loadPage : function(xid, url, options,viewLoadCallback,modelLoadCallback) {
			...
			if(isUI2 && options.type != "iframe" && !isJ(url)){
				...
				frame.src(url, function(iframe, duration){
					...
					modelLoadCallback && modelLoadCallback.call(this);
					options && options.onload && options.onload.call(this);
				});
			}	
		},
